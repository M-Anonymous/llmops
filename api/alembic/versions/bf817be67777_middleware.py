...
Revision ID: bf817be67777
Revises: f05c5542abfb
Create Date: 2026-07-28 09:58:14.067412
...
revision: str = 'bf817be67777'
down_revision: Union[str, Sequence[str], None] = 'f05c5542abfb'
...
def upgrade() -> None:
    ...
    op.add_column('middleware_info', sa.Column('label', sa.String(length=255), nullable=True, comment='中间价显示名称'))
...
def downgrade() -> None:
    ...
    op.alter_column('vector_store', 'id',
               ...
               existing_nullable=False)
    op.alter_column('model_info', 'desc',
               existing_type=sa.VARCHAR(length=255),
               comment='知识库描述',
               existing_comment='模型描述',
               existing_nullable=False)
    op.drop_column('middleware_info', 'label')
