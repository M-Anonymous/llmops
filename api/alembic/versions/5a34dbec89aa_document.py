...
Revision ID: 5a34dbec89aa
Revises: 6a837b240ce3
Create Date: 2026-07-25 09:17:11.751504
...
revision: str = '5a34dbec89aa'
down_revision: Union[str, Sequence[str], None] = '6a837b240ce3'
...
def upgrade() -> None:
    ...
    op.add_column('document_info', sa.Column('account_id', sa.Integer(), nullable=True, comment='关联的用户id'))
    op.add_column('document_info', sa.Column('status', sa.Integer(), nullable=True, comment='文件状态: 0 unprocess, 1 load, 2 clean, 3 split, 4 complete'))
...
def downgrade() -> None:
    ...
    op.drop_column('document_info', 'account_id')
