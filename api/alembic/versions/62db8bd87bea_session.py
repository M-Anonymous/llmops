...
Revision ID: 62db8bd87bea
Revises: b2c3d4e5f6a7
Create Date: 2026-07-27 15:02:44.154095
...
def upgrade() -> None:
    """Upgrade schema."""
    op.alter_column('session_info', 'visitor_id',
               existing_type=sa.VARCHAR(length=36),
               comment='访客 id（未登录用户，由前端传递）',
               existing_comment='访客 id',
...
def downgrade() -> None:
    ...
    op.alter_column('session_info', 'visitor_id',
               existing_type=sa.VARCHAR(length=36),
               comment='访客 id',
               existing_comment='访客 id（未登录用户，由前端传递）',
               existing_nullable=True)
