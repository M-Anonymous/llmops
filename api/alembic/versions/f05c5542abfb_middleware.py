...
Revision ID: f05c5542abfb
Revises: c3d4e5f6a7b8
Create Date: 2026-07-28 09:43:10.821143
...
def upgrade() -> None:
    ...
    op.add_column('agent_config', sa.Column('middleware_ids', postgresql.ARRAY(sa.String(length=36)), nullable=True, comment='关联的工具 中间件 列表'))
...
def downgrade() -> None:
    ...
    op.alter_column('model_info', 'desc',
               ...
               existing_nullable=False)
    op.drop_column('agent_config', 'middleware_ids')
